...
export default function RecetaCheesecake() {
    ...
    return (
        <div className={classes.contenedor}>
            <Titulos title="Cheesecake de frutos rojos"/>
            <div className={classes.recetaContenedor}>
            <Receta 
            src1="/src/img/cheesecake.png" 
            src2="/src/img/cheesecake2.png"
            src3="/src/img/cheesecake3.png"
            ingredientes={ingredientes} pasos={pasos} fecha="03 de octubre de 2023" tiempo={30}  porciones={8}/>            </div>
        </div>
    )
}
